    ...
    indicators.forEach(function(indicator){
        if(indicator == "industry_average" || indicator == "price_change"){
          ...
          if(indicator == "industry_average"){
            main_msg = 'The average price of the industry is ';
            main_msg += (data.unformatted_data.industry_average.average).toFixed(2) + " GBX.";
            companies.forEach(function(company){
            ...
            companies.forEach(function(company){
                var msg = "The price change of "+company+" is "+(data.unformatted_data[indicator][company]*100).toFixed(2)+"%. ";
                sub_msg.push(msg);
            });
